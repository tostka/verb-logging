# verb-logging.psm1
  ...
  * 11:29 AM 12.0.3017 initial version
  .DESCRIPTION
  verb-logging - Logging-related generic functions
  .LINK
...
function get-lastevent {
    ...
    * 7:19 AM 3/6/2020 rewriting to consolidate several get-lastxxx, with params to tag the variants, and an alias/function to deliver the matching names
    ...
    PS> get-lastevent -Logon ; 
        ...
        Teams chromium/Process Name: C:\Program Files (x86)\Microsoft\EdgeWebView\Application\132.0.3957.140\msedgewebview2.exe
    ...
    if($evts){
        ...
        $smsg += "`nTeams chromium/Process Name: C:\Program Files (x86)\Microsoft\EdgeWebView\Application\132.0.3957.140\msedgewebview2.exe"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUbUePPBMC3bPIZmpaHc6Wppum
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTMdBi1
# 63Mzt+88BBAGcIOvxuD1NTANBgkqhkiG9w0BAQEFAASBgGAAWpV7L2ttqH1Djh7/
# c6/yXsJgipBzBSIU7cblSdJdfa0P39CFAoRJHyRewaEx9yDLEXcXkkhJ0MKtYR9k
# KPJy08toVWN/flnwDsoEHXyuFjhrvNCH59YGCTmcLfcuUPLjjiaM24rUR0CPT3eF
# GX5y+eCB2ROClAzsioabtM2u
